...
export abstract class DynamoDBRepositoryBase<ResourceObject> {
        ...
        public static readonly PHASE_DETAIL_STATUSIndexName = process.env.DYNAMODB_MASTER_TABLE_PDS_INDEX_NAME!;
        public static readonly PHASE_AND_CLIENTID_IndexName = process.env.DYNAMODB_MASTER_TABLE_PACID_INDEX_NAME!;
        ...
        // GSIでdeleteItemは行えない
        protected getUUIDKey(input: ResourceObject) {
                return {
